...
const CardInfo: React.FC<CardInfoProps> = ({ title, value, linkText, linkUrl, Icon, isLoading }) => {
  return (
    <Card>
      ...
      <CardContent className="space-y-1">
        ...
        </div> : <span className="text-2xl font-bold tracking-tight">{value || value == 0 ? value : "-"}</span>}
        <Link to={linkUrl} className="text-xs text-muted-foreground flex items-center gap-1 transition-all hover:text-muted-foreground/80">
